...
class ExternalBnChangeAddressService extends \SoapClient
{
  ...
  'changeAddressRequestType' => 'App\\Asic\\changeAddressRequestType',
  'changeAddressReplyType' => 'App\\Asic\\changeAddressReplyType',
);
  ...
  'features' => 1,
      ...
      if (!$wsdl) {
        $wsdl = 'https://www.gateway.uat.asic.gov.au/gateway/ExternalBnChangeAddressPort?WSDL';
      }
      parent::__construct($wsdl, $options);
    }

    /**
     * @param changeAddressRequestType $request
     * @return changeAddressReplyType
     */
    public function externalBnChangeAddress(changeAddressRequestType $request)
    {
      return $this->__soapCall('externalBnChangeAddress', array($request));
    }
