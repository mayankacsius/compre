...
class ExternalBz1ServiceV2 extends \SoapClient
{
  ...
  'bz1RequestType' => 'App\\Asic\\bz1RequestType',
  'bz1ReplyType' => 'App\\Asic\\bz1ReplyType',
  'bz1ReplyDataType' => 'App\\Asic\\bz1ReplyDataType',
);
  ...
  'soap_version' => 2,
      ...
      if (!$wsdl) {
        $wsdl = 'https://www.gateway.uat.asic.gov.au/gateway/ExternalBz1PortV2?WSDL';
      }
      parent::__construct($wsdl, $options);
    }

    /**
     * @param bz1RequestType $request
     * @return bz1ReplyType
     */
    public function externalBz1(bz1RequestType $request)
    {
      return $this->__soapCall('externalBz1', array($request));
    }
