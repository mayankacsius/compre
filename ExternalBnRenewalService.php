...
class ExternalBnRenewalService extends \SoapClient
{
  ...
  'renewalRequestType' => 'App\\Asic\\renewalRequestType',
  'renewalReplyType' => 'App\\Asic\\renewalReplyType',
);
  ...
  'features' => 1,
      ...
      if (!$wsdl) {
        $wsdl = 'https://www.gateway.uat.asic.gov.au/gateway/ExternalBnRenewalPort?WSDL';
      }
      parent::__construct($wsdl, $options);
    }

    /**
     * @param renewalRequestType $request
     * @return renewalReplyType
     */
    public function externalBnRenewal(renewalRequestType $request)
    {
      return $this->__soapCall('externalBnRenewal', array($request));
    }
