...
class ExternalBnCancelTransferService extends \SoapClient
{
  ...
  'cancelRequestType' => 'App\\Asic\\cancelRequestType',
  'cancelReplyType' => 'App\\Asic\\cancelReplyType',
);
  ...
  'features' => 1,
      ...
      if (!$wsdl) {
        $wsdl = 'https://www.gateway.uat.asic.gov.au/gateway/ExternalBnCancelTransferPort?WSDL';
      }
      parent::__construct($wsdl, $options);
    }

    /**
     * @param cancelRequestType $request
     * @return cancelReplyType
     */
    public function externalBnCancelTransfer(cancelRequestType $request)
    {
      return $this->__soapCall('externalBnCancelTransfer', array($request));
    }
