...
class ExternalGetTransactionStatusService extends \SoapClient
{
  ...
  'transactionStatusRequestType' => 'App\\Asic\\transactionStatusRequestType',
  'businessDocumentBody' => 'App\\Asic\\businessDocumentBody',
  'transactionStatusReplyType' => 'App\\Asic\\transactionStatusReplyType',
  'transactionStatusReplyDataType' => 'App\\Asic\\transactionStatusReplyDataType',
  'lodgements' => 'App\\Asic\\lodgements',
  'registrations' => 'App\\Asic\\registrations',
  'companyIncorporation' => 'App\\Asic\\companyIncorporation',
  'statusReason' => 'App\\Asic\\statusReason',
  'businessRegistration' => 'App\\Asic\\businessRegistration',
  'reservation' => 'App\\Asic\\reservation',
  'reservationExtension' => 'App\\Asic\\reservationExtension',
  'feePayment' => 'App\\Asic\\feePayment',
);
  ...
  'soap_version' => 2,
      ...
      if (!$wsdl) {
        $wsdl = 'https://www.gateway.uat.asic.gov.au/gateway/ExternalGetTransactionStatusPort?WSDL';
      }
      parent::__construct($wsdl, $options);
    }

    /**
     * @param transactionStatusRequestType $request
     * @return transactionStatusReplyType
     */
    public function externalGetTransactionStatus(transactionStatusRequestType $request)
    {
      return $this->__soapCall('externalGetTransactionStatus', array($request));
    }
