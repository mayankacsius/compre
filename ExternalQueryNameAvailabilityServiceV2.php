...
class ExternalQueryNameAvailabilityServiceV2 extends \SoapClient
{
  ...
  'queryNameAvailabilityRequestType' => 'App\\Asic\\queryNameAvailabilityRequestType',
  'queryNameAvailabilityReplyType' => 'App\\Asic\\queryNameAvailabilityReplyType',
);
  ...
  'soap_version' => 2,
      ...
      if (!$wsdl) {
        $wsdl = 'https://www.gateway.uat.asic.gov.au/gateway/ExternalQueryNameAvailabilityPortV2?WSDL';
      }
      parent::__construct($wsdl, $options);
    }

    /**
     * @param queryNameAvailabilityRequestType $request
     * @return queryNameAvailabilityReplyType
     */
    public function externalQueryNameAvailability(queryNameAvailabilityRequestType $request)
    {
      return $this->__soapCall('externalQueryNameAvailability', array($request));
    }
