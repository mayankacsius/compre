...
class ExternalQueryAddressService extends \SoapClient
{
  ...
  'queryAddressRequestType' => 'App\\Asic\\queryAddressRequestType',
  'queryAddressReplyType' => 'App\\Asic\\queryAddressReplyType',
  ...
  'features' => 1,
      ...
      if (!$wsdl) {
        $wsdl = 'https://www.gateway.uat.asic.gov.au/gateway/ExternalQueryAddressPort?WSDL';
      }
      parent::__construct($wsdl, $options);
    }

    /**
     * @param queryAddressRequestType $request
     * @return queryAddressReplyType
     */
    public function externalQueryAddress(queryAddressRequestType $request)
    {
      return $this->__soapCall('externalQueryAddress', array($request));
    }
