...
class ExternalCompanyLodgementService extends \SoapClient
{
  ...
  'CompanyLodgeRequestType' => 'App\\Asic\\CompanyLodgeRequestType',
  'CompanyLodgeReplyType' => 'App\\Asic\\CompanyLodgeReplyType',
  'CompanyLodgeReplyDataType' => 'App\\Asic\\CompanyLodgeReplyDataType',
  'accepted' => 'App\\Asic\\accepted',
);
  ...
  'soap_version' => 2,
      ...
      if (!$wsdl) {
        $wsdl = 'https://www.gateway.uat.asic.gov.au/gateway/ExternalCompanyLodgementPort?WSDL';
      }
      parent::__construct($wsdl, $options);
    }

    /**
     * @param CompanyLodgeRequestType $request
     * @return CompanyLodgeReplyType
     */
    public function externalCompanyLodgement(CompanyLodgeRequestType $request)
    {
      return $this->__soapCall('externalCompanyLodgement', array($request));
    }
